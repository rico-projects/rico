...
public class InterceptorTimingTest extends AbstractIntegrationTest {

    @Test(dataProvider = ENDPOINTS_DATAPROVIDER)
    public void testCall1(String containerType, String endpoint) throws Exception {

        //given
        final String url = endpoint + "/rest/interceptor-timing/1";
    ...
    public void testCall3(final String containerType, final String endpoint) throws Exception {
        ...
        //given
        final String url = endpoint + "/rest/interceptor-timing/3";
