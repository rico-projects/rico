...
import dev.rico.internal.remoting.server.model.ServerPresentationModelBuilder;
...
public class ServerPresentationModelBuilderTest extends AbstractRemotingTest {
    ...
    public void testSimpleCreation() {
        ...
        assertEquals(model.getAttributes().get(0).getPropertyName(), LegacyConstants.SOURCE_SYSTEM);
        assertEquals(model.getAttributes().get(0).getValue(), LegacyConstants.SOURCE_SYSTEM_SERVER);
    }
    ...
    public void testWithAttributeCreation() {
        ...
        assertNotNull(model.getAttribute(LegacyConstants.SOURCE_SYSTEM));
