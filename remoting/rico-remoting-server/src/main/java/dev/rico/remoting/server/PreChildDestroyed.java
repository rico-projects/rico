...
/**
 * Can you used to annotate a method in a remoting controller (see {@link RemotingController}) as an event handler that will automatically be called if a child controller of the given controller will be destroyed (see client API).
