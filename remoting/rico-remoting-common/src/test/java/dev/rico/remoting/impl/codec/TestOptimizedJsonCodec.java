...
public class TestOptimizedJsonCodec {
    ...
    public void shouldEncodeEmptyList() {
        final String actual = Codec.getInstance().encode(Collections.<Command>emptyList());
    ...
    public void shouldEncodeSingleCreatePresentationModelCommand() {
        ...
        final String actual = Codec.getInstance().encode(Collections.singletonList(command));
    ...
    public void shouldEncodeCallActionCommand() {
        ...
        final String actual = Codec.getInstance().encode(Collections.<Command>singletonList(command));
    ...
    public void shouldEncodeTwoCustomCodecCommands() {
        final Command command = createCPMCommand();
        final String actual = Codec.getInstance().encode(Arrays.asList(command, command));
    ...
    public void shouldEncodeCustomCodecCommandAndStandardCodecCommand() {
        ...
        final String actual = Codec.getInstance().encode(Arrays.asList(customCodecCommand, standardCodecCommand));
    ...
    public void shouldEncodeStandardCodecCommandAndCustomCodecCommand() {
        final Command standardCodecCommand = createCommand();
        final Command customCodecCommand = createCPMCommand();
        final String actual = Codec.getInstance().encode(Arrays.asList(standardCodecCommand, customCodecCommand));
        final String standardCodecCommandString = createCommandJsonString();
        final String customCodecCommandString = createCPMCommandString();
    ...
    public void shouldDecodeEmptyList() {
        final List<Command> commands = Codec.getInstance().decode("[]");
        assertThat(commands, Matchers.<Command>empty());
    }

    @Test
    public void shouldDecodeValueChangedCommandWithNulls() {
        final List<Command> commands = Codec.getInstance().decode("[{\"a_id\":\"3357S\",\"id\":\"ValueChanged\"}]");
    ...
    public void shouldDecodeValueChangedCommandWithStrings() {
        final List<Command> commands = Codec.getInstance().decode("[{\"a_id\":\"3357S\",\"v\":\"Good Bye\",\"id\":\"ValueChanged\"}]");
    ...
    public void shouldDecodeValueChangedCommandWithIntegers() {
        final List<Command> commands = Codec.getInstance().decode("[{\"a_id\":\"3357S\",\"v\":42,\"id\":\"ValueChanged\"}]");
    ...
    public void shouldDecodeValueChangedCommandWithLong() {
        final List<Command> commands = Codec.getInstance().decode("[{\"a_id\":\"3357S\",\"v\":987654321234567890,\"id\":\"ValueChanged\"}]");
    ...
    public void shouldDecodeValueChangedCommandWithDoubles() {
        final List<Command> commands = Codec.getInstance().decode("[{\"a_id\":\"3357S\",\"v\":2.7182,\"id\":\"ValueChanged\"}]");
    ...
    public void shouldDecodeValueChangedCommandWithUuid() {
        final List<Command> commands = Codec.getInstance().decode("[{\"a_id\":\"3357S\",\"v\":\"{4b9e93fd-3738-4fe6-b2a4-1fea8d2e0dc4}\",\"id\":\"ValueChanged\"}]");
    ...
    public void shouldDecodeValueChangedCommandWithBooleans() {
        final List<Command> commands = Codec.getInstance().decode("[{\"a_id\":\"3357S\",\"v\":false,\"id\":\"ValueChanged\"}]");
    ...
    public void shouldDecodeSingleNamedCommand() {
        final List<Command> commands = Codec.getInstance().decode("[" + createCommandJsonString() + "]");
    ...
    public void shouldDecodeCallActionCommand() {
        ...
        //when:
        final List<Command> commands = Codec.getInstance().decode(json);
    ...
    public void testQualifierSupport() {
        ...
        final  List<Command> commands = Codec.getInstance().decode(input);
        Assert.assertNotNull(commands);
