...
Prometheus will try to fetch metrics records from each servewr in this array

Next to this wer need to create a Docker file that extends the default Docker image from Prometheus and adds our custom configuration:
