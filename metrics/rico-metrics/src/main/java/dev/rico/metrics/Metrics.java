...
public interface Metrics {
     ...
     * @return the counter
     */
    Counter getOrCreateCounter(String name, StringPair... context);
     ...
     * @return the timer
     */
    Timer getOrCreateTimer(String name, StringPair... context);
     ...
     * @return the gauge
     */
    Gauge getOrCreateGauge(String name, StringPair... context);
